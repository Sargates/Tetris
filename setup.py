...
# I got this off the internet long time ago, I can't site the source but I **did not** write this
def setup():
	...
	if int(var[0]) >= 3:
		...
		print("Python Version is out of date, please update python version to a version newer than Python 3.0.0 and rerun")
		time.sleep(10)
		sys.exit()
